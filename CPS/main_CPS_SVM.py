...
if __name__ == '__main__':
    ...
    for s in range(len(files)):
        ...
        lambda1_list = [0.5]  # parameter beta list 
        lambda2_list = [0.4]  # parameter alpha list 
            ...
            for l in range(10):
                ...
                for train_index, test_index in kf.split(X, y):
                    ...
                    for n in range(len(lambda2_list)):
                        ...
                        result = SVM(train_pattern_resampled, train_label_resampled, test_pattern)
